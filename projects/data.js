/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   ...
   Fields:
     id          â€” matches the HTML filename  e.g. 'lego-minifig' â†’ projects/lego-minifig.html
     published   â€” false hides it everywhere (cards, terminal, modal)
     type        â€” 'hw' | 'sw' | 'both'  (controls card colour theme)
     tabs        â€” array of tab filters this card appears under: 'built' | 'led' | 'launched'
     wip         â€” true shows a WIP badge on the card
     title       â€” project name
     emoji       â€” fallback if no thumbnail
     thumbnail   â€” cloudinary URL (or null to use emoji)
     label       â€” short category label shown on the card
     desc        â€” one-liner shown on the card
     previewDesc â€” longer description shown in the preview modal
     tags        â€” array of tag strings shown in the modal
     url         â€” path to the project page (or '#' if none yet)

   Page-content fields (used by _shell.js renderPage()):
     heroTitle   â€” h1 text with <em> around last word
     purpose     â€” { heading, body: [...paragraphs], images? }
     process     â€” { heading, summary, steps: [{title, body}], images? }
     result      â€” { heading, body: [...paragraphs], stats: [{val, label}], images? }
     blocks      â€” [] array of extra content blocks (video, gallery, code, cad, image)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
<div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:rgba(240,240,248,0.25);text-align:right;letter-spacing:.05em;">ABSOLUTE PRESSURE (hPa) â€” log scale</div>
<script>
(function(){
  ...
  new Chart(document.getElementById('qset-press-chart'),{type:'line',plugins:[phases],data:{labels:labels,datasets:[{label:'Pressure (hPa)',data:pr,borderColor:'#2E8CF0',borderWidth:1.5,tension:0.3,pointRadius:0,fill:true,backgroundColor:'rgba(46,140,240,0.06)'}]},options:{responsive:true,maintainAspectRatio:false,animation:false,plugins:{legend:{display:false},tooltip:tip},scales:{x:xScale,y:{type:'logarithmic',ticks:{color:tc,font:{family:'JetBrains Mono',size:9},callback:function(v){return v>=100?Math.round(v):v.toFixed(0)}},grid:{color:g},border:{color:g}}}}});
        ...
        { type: "year", title: "2024" },
        {
          ...
          body: "Both programs ran in parallel â€” university students through Space School, high schoolers through Connections to Space. Two different programs that taught the same skills: embedded systems, circuit design, soldering, and CAD.",
        },
        {
        ...
        },
        {
          ...
          body: "Students in both groups picked what excited them, designed their modules, and wired everything themselves. Missions ranged widely â€” one student wanted to measure radon at different altitudes, another set up cameras to capture images during the ascent.",
          blockAfter: {
            type: "image",
        ...
        },
        {
          title: "Launch Day",
          body: [
            "Launch windows are weather-dependent. Wind speed, direction, and upper atmosphere conditions all determine whether you can go that day. Once we got the green light, we were up before dawn â€” transporting the helium, filling the balloon on-site. Both satellites went up on the same balloon.",
    ...
    result: {
      ...
      stats: [
        ...
        { val: "â†‘40%", label: "Retention" },
        { val: "â†“15%", label: "Mission Costs" },
      ],
    },
    blocks: [],
  },
    ...
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Final build: 90+ hours of print time across both figures. Parts assembled in the designed sequence â€” joints clicked in, figures posed. No adhesive, no hardware.",
          blockAfter: {
            type: "split",
            left: {
              type: "video",
      ...
      steps: [
        {
          ...
          body: "Wrote the proposal that secured $50K from the CSA. The grant covered all program costs â€” components, tools, launch logistics â€” so participants paid nothing. Writing the proposal meant articulating the educational value, the partnership structure, and the technical feasibility of putting student-built hardware into the stratosphere.",
        },
        {
...

  {
    ...
    purpose: {
      heading: "Why I <em>built this.</em>",
      body: [
        "Sonder is a word for the realization that every person you pass on the street has a life as vivid and complex as your own â€” full of ambitions, fears, routines, and relationships you'll never know. It's the kind of thought that makes you feel more connected to strangers and less alone.",
        "I wanted to build something that made people feel that. Not through a social media platform, not through an algorithm that curates what you see â€” through something physical, accidental, and unfiltered. You find a letter in a mailbox. You scan a tag. A stranger's words appear on your screen. Then you write back.",
        "The project is a social experiment as much as an engineering one: what do people actually say when there's no audience, no likes, no followers â€” just a stranger who might read it?",
      ],
    },
    process: {
      heading: "How I <em>built it.</em>",
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Built the full frontend experience â€” a scroll-to-open envelope animation that reveals a stranger's letter as you scroll down, followed by a reply form. Designed to feel like opening a real letter, not filling out a form. Hosted on Netlify. Live at project-sonder.netlify.app.",
        },
        {
          title: "Web platform: backend and database",
          body: "Built the backend: letter storage, random letter retrieval logic, submission handling. When you scan a tag and load the page, you get a random letter from the database. When you write one, it enters the pool for the next person who finds that mailbox. No accounts, no profiles, no history â€” just the exchange.",
        },
        {
          title: "NFC tag integration",
          body: "Each physical letter has an embedded NFC tag programmed to open the web URL on tap. QR code backup for devices without NFC. The tag is the bridge between the physical object and the digital experience â€” someone who doesn't know what NFC is can still just tap and have it work.",
        },
        {
          title: "Physical letter and mailbox design (in progress)",
          body: "Designing the 3D-printed letter form and mailbox enclosures for outdoor installation. The letter needs to be weather-resistant, durable, and feel intentional â€” something worth picking up and engaging with. The mailbox needs a flag mechanism (raised = there's mail) to signal to passersby that something is there.",
        },
      ],
    },
    result: {
...

  {
    ...
    process: {
      ...
      summary:
        "Three props, three different finishing challenges â€” each one pushing a different part of the fabrication process.",
      steps: [
...

  {
    ...
    type: "both",
    tabs: ["built", "led", "launched"],
    title: "STEM Outreach â€” Connections",
    emoji: "âš¡",
    thumbnail:
    ...
    process: {
      ...
      summary: "",
      steps: [
        { type: "year", title: "Summer 2021 â€” Instructor" },
        {
          title: "",
        ...
        { type: "year", title: "2021â€“2022 â€” Content Creator" },
        {
          title: "",
          body: "Built three courses: Python fundamentals, ML for object detection, and web scraping and data analysis. Designed to be accessible but not shallow â€” students trained their own vision models and built their own scrapers.",
        },
        { type: "year", title: "Summer 2022 â€” Lead Instructor" },
        {
          title: "",
        ...
        { type: "year", title: "2022â€“2023 â€” Mechatronics Intern" },
        {
          title: "",
          body: "Designed the gesture-controlled car from participant feedback data â€” it became the highest-rated project in 20+ summer programs. Also developed a series of LEGO-based projects focused on lunar exploration.",
        },
        { type: "year", title: "Summer 2023 â€” Mechatronics Engineer" },
        {
          title: "",
        ...
        { type: "year", title: "2023â€“2024 â€” Mechatronics Engineer" },
        {
          title: "",
...

  {
    ...
    type: "hw",
    tabs: ["led", "launched"],
    title: "FIRST Robotics â€” Team 19528",
    emoji: "ðŸ†",
    thumbnail:
    ...
    purpose: {
      ...
      body: [
        "FIRST Tech Challenge gives high school students access to real robotics competition â€” but only if someone shows up to teach them. Team 19528 (Tech Comet Lancers) needed a mentor who could cover the full technical stack: mechanical, electrical, and software. I had all of it, and I wanted to give it back.",
        "I committed for two years. Two to three times a week, build season and off-season. The goal wasn't to build their robot for them â€” it was to get to the point where they could build it themselves.",
      ],
    },
    process: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Worked through control algorithm development for the drive train and autonomous routines â€” PID basics, sensor integration, state machines for autonomous sequences. This is where the electrical and software work comes together, and where a lot of teams struggle. Focused on making sure students understood what the code was doing, not just that it worked.",
        },
        {
          title: "Competition judging",
          body: "Also served as a competition judge across both seasons, which gave me a different view of the program â€” understanding how robots and teams are evaluated beyond just whether the mechanism functions.",
        },
        {
          title: "Year two: raising the ceiling",
          body: "Year two the team came back with a foundation. The work shifted from fundamentals to optimization: improving mechanisms, refining autonomous routines, thinking strategically about game design. The awards in year two â€” Design and Connect â€” reflected a team that had internalized the engineering process, not just executed a build.",
        },
      ],
    },
    result: {
